...
public class Bend180degreeCircular extends AbstractElement {
	...
	public Bend180degreeCircular(
		...
		this.angleDegree = 180 ; // could be positive or negative
		angleRad = this.angleDegree* Math.PI/180 ;
		this.toRight = false ;
		setParams() ;
		setPorts() ;
		setVertices() ;
	...
	public String[] getPythonCode(String fileName, String topCellName){
		String st01 = "## ---------------------------------------- ##" ;
		String st02 = "##       Adding a 180 DEGREE BEND           ##" ;
		String st03 = "## ---------------------------------------- ##" ;
